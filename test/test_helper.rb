...
#  fixtures :all
  ...
  def setup_annotation(options = {})
    annotation = Annotation.new
    annotation.collage = options[:collage] || @collage
    annotation.annotated_content = options[:annotated_content] || "first content"
    annotation.annotation = options[:content] || "content"
    annotation.annotation_start = options[:annotation_start] || "T1"
    annotation.annotation_end = options[:annotation_end] || "T100"
    annotation.save!
